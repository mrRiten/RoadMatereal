...
namespace RoadMatereal.Migrations
{
    ...
    [Migration("20240923064829_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RoadMatereal.Models.OrderItem", b =>
                {
            ...
            modelBuilder.Entity("RoadMatereal.Models.Supplier", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("RoadMatereal.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RoadMatereal.Models.Order", b =>
                {
                    b.HasOne("RoadMatereal.Models.ApplicationUser", "Client")
                        .WithMany()
                        .HasForeignKey("ClientID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RoadMatereal.Models.Status", "Status")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("RoadMatereal.Models.OrderItem", b =>
                {
                    b.HasOne("RoadMatereal.Models.Material", "Material")
                        .WithMany("OrderItems")
                        .HasForeignKey("MaterialID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RoadMatereal.Models.Order", "Order")
                        .WithMany("OrderItems")
